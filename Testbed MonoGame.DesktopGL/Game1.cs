...
using Testbed_MonoGame.DesktopGL.Framework;
using Testbed_MonoGame.DesktopGL.Tests;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Input;
using FarseerPhysics;

namespace Testbed_MonoGame.DesktopGL
{
    /// <summary>
    ...
    public class Game1 : Game
    {
        ...
        private bool ShowAdditionalControls = true;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            else if (_keyboardManager.IsNewKeyPress(Keys.H))
            {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            {
                _test.DebugView.DrawString(50, 300, $@"
[ArrowKeys] Move Cam
[Z,X] Zoom Cam+-
[O,I] Sample+-
[P] Pause
