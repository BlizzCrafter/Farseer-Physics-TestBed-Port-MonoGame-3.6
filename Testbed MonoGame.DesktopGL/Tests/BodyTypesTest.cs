...
namespace Testbed_MonoGame.DesktopGL.Tests
{
    public class BodyTypesTest : Test
    {
        ...
        private BodyTypesTest()
        {
            ...
            // Define platform
            {
                ...
                _platform.Position = new Vector2(0.0f, 0.0f);
                ...
                PrismaticJoint pjd = new PrismaticJoint(ground, _platform, new Vector2(0.0f, 0.0f), new Vector2(1.0f, 0.0f), true);
